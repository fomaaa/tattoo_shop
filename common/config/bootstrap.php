...
Yii::setAlias('@imagePath', 'C:\OSPanel\domains\tatoo.loc\frontend\web\images\\');
Yii::setAlias('@imageUrl', 'http://admin.tatoo.loc/images/');
Yii::setAlias('@Url', 'http://admin.tatoo.loc/');
